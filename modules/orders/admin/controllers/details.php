<?php 
    ...
    $result = mysqli_query($con, "SELECT * FROM orders o LEFT JOIN orders_bill ob ON o.BillId = ob.BillId LEFT JOIN orders_delivery od ON o.DeliveryId = od.DeliveryId LEFT JOIN orders_invoice oi ON o.InvoiceId = oi.InvoiceId WHERE o.OrderId = '$id'");
    $orders = array();
